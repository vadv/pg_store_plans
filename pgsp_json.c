...
word_table propfields[] = {
    { P_NodeType, "t", "Node Type", NULL, true, conv_nodetype,
      SETTER(node_type) },
    { P_RelationShip, "h", "Parent Relationship", NULL, true, conv_relasionship,
      NULL },
    { P_RelationName, "n", "Relation Name", NULL, true, NULL,
      SETTER(obj_name) },
    ...
    { P_ScanDir, "d", "Scan Direction", NULL, true, conv_scandir,
      SETTER(scan_dir) },
    { P_MergeCond, "m", "Merge Cond", NULL, true, conv_expression,
      SETTER(merge_cond) },
    { P_Strategy, "g", "Strategy", NULL, true, conv_strategy,
      SETTER(strategy) },
    { P_JoinType, "j", "Join Type", NULL, true, conv_jointype,
      SETTER(join_type) },
    { P_SortMethod, "e", "Sort Method", NULL, true, conv_sortmethod,
      SETTER(sort_method) },
    { P_SortKey, "k", "Sort Key", NULL, true, conv_expression,
      SETTER(sort_key) },
    { P_Filter, "5", "Filter", NULL, true, conv_expression, SETTER(filter) },
    { P_JoinFilter, "6", "Join Filter", NULL, true, conv_expression,
      SETTER(join_filter) },
    { P_HashCond, "7", "Hash Cond", NULL, true, conv_expression,
      SETTER(hash_cond) },
    { P_IndexCond, "8", "Index Cond", NULL, true, conv_expression,
      SETTER(index_cond) },
    { P_TidCond, "9", "TID Cond", NULL, true, conv_expression,
      SETTER(tid_cond) },
    { P_RecheckCond, "0", "Recheck Cond", NULL, true, conv_expression,
      SETTER(recheck_cond) },
    { P_Operation, "!", "Operation", NULL, true, conv_operation,
      SETTER(operation) },
    { P_SubplanName, "q", "Subplan Name", NULL, true, NULL,
      SETTER(subplan_name) },
    { P_Command, "b", "Command", NULL, true, conv_setsetopcommand,
      SETTER(setopcommand) },
    ...
    { P_Parallel, "`", "Parallel Aware", NULL, true, NULL,
      SETTER(parallel_aware) },
    { P_PartialMode, ">", "Partial Mode", NULL, true, conv_partialmode,
      SETTER(partial_mode) },
    { P_WorkersPlanned, "{", "Workers Planned", NULL, true, NULL,
      SETTER(workers_planned) },
    { P_WorkersLaunched, "}", "Workers Launched", NULL, true, NULL,
      SETTER(workers_launched) },
    { P_InnerUnique, "?", "Inner Unique", NULL, true, NULL,
      SETTER(inner_unique) },

    /* Values of these properties are ignored on normalization */
    { P_FunctionCall, "y", "Function Call", NULL, false, NULL,
      SETTER(func_call) },
    { P_StartupCost, "1", "Startup Cost", NULL, false, NULL,
      SETTER(startup_cost) },
    ...
    { P_ActualStartupTime, "A", "Actual Startup Time", NULL, false, NULL,
      SETTER(actual_startup_time) },
    { P_ActualTotalTime, "B", "Actual Total Time", NULL, false, NULL,
      SETTER(actual_total_time) },
    { P_ActualRows, "C", "Actual Rows", NULL, false, NULL,
      SETTER(actual_rows) },
    { P_ActualLoops, "D", "Actual Loops", NULL, false, NULL,
      SETTER(actual_loops) },
    { P_HeapFetches, "E", "Heap Fetches", NULL, false, NULL,
      SETTER(heap_fetches) },
    { P_SharedHitBlks, "F", "Shared Hit Blocks", NULL, false, NULL,
      SETTER(shared_hit_blks) },
    { P_SharedReadBlks, "G", "Shared Read Blocks", NULL, false, NULL,
      SETTER(shared_read_blks) },
    { P_SharedDirtiedBlks, "H", "Shared Dirtied Blocks", NULL, false, NULL,
      SETTER(shared_dirtied_blks) },
    { P_SharedWrittenBlks, "I", "Shared Written Blocks", NULL, false, NULL,
      SETTER(shared_written_blks) },
    { P_LocalHitBlks, "J", "Local Hit Blocks", NULL, false, NULL,
      SETTER(local_hit_blks) },
    { P_LocalReadBlks, "K", "Local Read Blocks", NULL, false, NULL,
      SETTER(local_read_blks) },
    { P_LocalDirtiedBlks, "L", "Local Dirtied Blocks", NULL, false, NULL,
      SETTER(local_dirtied_blks) },
    { P_LocalWrittenBlks, "M", "Local Written Blocks", NULL, false, NULL,
      SETTER(local_written_blks) },
    { P_TempReadBlks, "N", "Temp Read Blocks", NULL, false, NULL,
      SETTER(temp_read_blks) },
    { P_TempWrittenBlks, "O", "Temp Written Blocks", NULL, false, NULL,
      SETTER(temp_written_blks) },
    { P_IOReadTime, "P", "I/O Read Time", NULL, false, NULL,
      SETTER(io_read_time) },
    { P_IOWwriteTime, "Q", "I/O Write Time", NULL, false, NULL,
      SETTER(io_write_time) },
    { P_SortSpaceUsed, "R", "Sort Space Used", NULL, false, NULL,
      SETTER(sort_space_used) },
    { P_SortSpaceType, "S", "Sort Space Type", NULL, false, conv_sortspacetype,
      SETTER(sort_space_type) },
    { P_PeakMemoryUsage, "T", "Peak Memory Usage", NULL, false, NULL,
      SETTER(peak_memory_usage) },
    { P_OrgHashBatches, "U", "Original Hash Batches", NULL, false, NULL,
      SETTER(org_hash_batches) },
    { P_OrgHashBuckets, "*", "Original Hash Buckets", NULL, false, NULL,
      SETTER(org_hash_buckets) },
    { P_HashBatches, "V", "Hash Batches", NULL, false, NULL,
      SETTER(hash_batches) },
    { P_HashBuckets, "W", "Hash Buckets", NULL, false, NULL,
      SETTER(hash_buckets) },
    { P_RowsFilterRmvd, "X", "Rows Removed by Filter", NULL, false, NULL,
      SETTER(filter_removed) },
    { P_RowsIdxRchkRmvd, "Y", "Rows Removed by Index Recheck", NULL, false,
      NULL, SETTER(idxrchk_removed) },
    ...
    { P_ExactHeapBlks, "&", "Exact Heap Blocks", NULL, false, NULL,
      SETTER(exact_heap_blks) },
    { P_LossyHeapBlks, "(", "Lossy Heap Blocks", NULL, false, NULL,
      SETTER(lossy_heap_blks) },
    { P_RowsJoinFltRemvd, ")", "Rows Removed by Join Filter", NULL, false, NULL,
      SETTER(joinfilt_removed) },
    { P_TargetTables, "_", "Target Tables", NULL, false, NULL, NULL },
    { P_ConfRes, "%", "Conflict Resolution", NULL, false, NULL,
      SETTER(conflict_resolution) },
    { P_ConfArbitIdx, "@", "Conflict Arbiter Indexes", NULL, false, NULL,
      SETTER(conflict_arbiter_indexes) },
    { P_TuplesInserted, "^", "Tuples Inserted", NULL, false, NULL,
      SETTER(tuples_inserted) },
    { P_ConfTuples, "+", "Conflicting Tuples", NULL, false, NULL,
      SETTER(conflicting_tuples) },
    { P_SamplingMethod, ":", "Sampling Method", NULL, false, NULL,
      SETTER(sampling_method) },
    { P_SamplingParams, ";", "Sampling Parameters", NULL, false, NULL,
      SETTER(sampling_params) },
    { P_RepeatableSeed, "<", "Repeatable Seed", NULL, false, NULL,
      SETTER(repeatable_seed) },
    { P_Workers, "[", "Workers", NULL, false, NULL, NULL },
    { P_WorkerNumber, "]", "Worker Number", NULL, false, NULL,
      SETTER(worker_number) },
    { P_TableFuncName, "aa", "Table Function Name", NULL, false, NULL,
      SETTER(table_func_name) },

    { P_PresortedKey, "pk", "Presorted Key", NULL, false, NULL,
      SETTER(presorted_key) },
    { P_FullsortGroups, "fg", "Full-sort Groups", NULL, false, NULL, NULL },
    { P_SortMethodsUsed, "su", "Sort Methods Used", NULL, false, NULL,
      SETTER(sortmethod_used) },
    { P_SortSpaceMemory, "sm", "Sort Space Memory", NULL, false, NULL,
      SETTER(sortspace_mem) },
    { P_GroupCount, "gc", "Group Count", NULL, false, NULL,
      SETTER(group_count) },
    { P_AvgSortSpcUsed, "as", "Average Sort Space Used", NULL, false, NULL,
      SETTER(avg_sortspc_used) },
    { P_PeakSortSpcUsed, "ps", "Peak Sort Space Used", NULL, false, NULL,
      SETTER(peak_sortspc_used) },
...
word_table nodetypes[] = {
    ...
    { T_NamedTuplestoreScan, "9", "Named Tuplestore Scan", NULL, false, NULL,
      NULL },
...
word_table jointypes[] = { { T_Invalid, "i", "Inner", NULL, false, NULL, NULL },
...
word_table *search_word_table(word_table *tbl, const char *word, int mode) {
    ...
    bool longname = (mode == PGSP_JSON_SHORTEN || mode == PGSP_JSON_NORMALIZE);
...
#define IS_CONST(tok)                                                          \
    (tok == FCONST || tok == SCONST || tok == BCONST || tok == XCONST ||       \
     tok == ICONST || tok == NULL_P || tok == TRUE_P || tok == FALSE_P ||      \
     tok == CURRENT_DATE || tok == CURRENT_TIME || tok == LOCALTIME ||         \
     tok == LOCALTIMESTAMP)
 ...
 */
static int norm_yylex(char *str, core_YYSTYPE *yylval, YYLTYPE *yylloc,
...
void normalize_expr(char *expr, bool preserve_space) {
    ...
    for (;;) {
        ...
        if (lastloc >= 0) {
             ...
             */
            if (tok > 0 && i2 < start &&
                (preserve_space || (tok >= IDENT && lasttok >= IDENT &&
...
static void json_arrend(void *state) {
    ...
    if (ctx->mode == PGSP_JSON_INFLATE &&
        (IS_INDENTED_ARRAY(ctx->current_list) ? ctx->wlist_level == 0
...
static void json_ofstart(void *state, char *fname, bool isnull) {
    ...
    if (!p) {
        ereport(DEBUG1,
                (errmsg("JSON parser encoutered unknown field name: \"%s\".",
                        fname),
                 errdetail_log("INPUT: \"%s\"", ctx->org_string)));
    }

    ctx->remove =
        (ctx->mode == PGSP_JSON_NORMALIZE && (!p || !p->normalize_use));
...
static void json_ofend(void *state, char *fname, bool isnull) {
    pgspParserContext *ctx = (pgspParserContext *)state;
...
static void json_aestart(void *state, bool isnull) {
    ...
    if (IS_INDENTED_ARRAY(ctx->current_list) && ctx->wlist_level == 1) {
        if (!bms_is_member(ctx->level, ctx->first))
            appendStringInfoChar(ctx->dest, ',');
 ...
 */
bool run_pg_parse_json(JsonLexContext *lex, JsonSemAction *sem) {
#if PG_VERSION_NUM >= 130000
