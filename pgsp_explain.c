...
static void report_triggers(ResultRelInfo *rInfo, bool show_relname,
                            ExplainState *es);
static void pgspExplainPropertyText(const char *qlabel, const char *value,
                                    ExplainState *es);
static void pgspExplainPropertyFloat(const char *qlabel, double value,
                                     int ndigits, ExplainState *es);
static void pgspExplainProperty(const char *qlabel, const char *value,
